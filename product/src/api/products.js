...
module.exports = (app) => {
    ...
    app.put('/wishlist', UserAuth, async (req, res, next) => {
        ...
        try {
            ...
            return res.status(200).json({ message: "Whish List Fetched ✅ ", whishlist: data.data.product });
    ...
    app.delete('/wishlist/:id', UserAuth, async (req, res, next) => {
        ...
        try {
            ...
            PublishCustomerEvent(data)
            return res.status(200).json({ wishlist: data.data.product, message: "Removed ✅" });
